...
export const registerClientCommands = ({
  ...
  const restartCmd = vscode.commands.registerCommand("tw2panda-vscode.restart", async () => {
  ...
  const showOutputCmd = vscode.commands.registerCommand("tw2panda-vscode.show-output", async () => {
  ...
  const openConfigCmd = vscode.commands.registerCommand("tw2panda-vscode.open-config", async () => {
